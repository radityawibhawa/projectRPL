    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url();?>Admin/viewMessage" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url();?>Admin/viewRent" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url();?>Admin/viewCars" class="nav-link">
