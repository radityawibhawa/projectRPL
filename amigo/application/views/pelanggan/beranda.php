...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
    <div class="carousel-inner" id="review">
        <div class="carousel-item active">
            <div class="f">
                <div class="column1">
                    ...
                    <p></p>
                    <h5>Ahmad Yani</h5>
                    <p>Puas dengan pelayanan, kenyamanan, dan performa dari mobil yang disewakan.</p><br>
                    <p>Innova reborn 2016</p>
                </div>
                <div class="column1">
                    <img src="assets/img/profile.webp" alt="" style="width:128px;height:128px;">
                    <p></p>
                    <h5>Abdul Temon</h5>
                    <p>Pokoknya bagus, rental terecommended.</p><br><br>
                    <p>Xenia</p>
                </div>
                <div class="column1">
                    <img src="assets/img/profile.webp" alt="" style="width:128px;height:128px;">
                    <p></p>
                    <h5>Raditya Dika</h5>
                    <p>Mobil aman, pelayanan bagus, mantap dah.</p><br><br>
                    <p style>Honda Brio</p>
                </div>
            </div>
        </div>
                                ...
                                <div class="mobil_section_2">
                                    <div class="row">
                                        <div class="col-lg-4 col-sm-4">
                                            <div class="box_main">
                                                <div class="mobil1"><img src="assets/img/honda fit.jpg" alt="" style="width:280px;height:150px;"></div>
                                                <h7 class="shirt_text">Innova Reborn 2016</h7>
                                                <p class="price_text">Mulai dari Rp.500.000</p>
                                                <div class="btn_main">
                                                    <div class="seemore_bt"><a href="<?= base_url('Detail_sewa'); ?>">Info Selanjutnya</a></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-sm-4">
