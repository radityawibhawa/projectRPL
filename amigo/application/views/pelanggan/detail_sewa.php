...
<section class="page-section" id="desc">
    ...
    <div class="row">
        ...
        <!-- Durasi atau Lamanya mobil akan disewa -->
        <div class="column side">
            <form action="/action_page.php">
        ...
        <div class="row">
            ...
            <div class="modal fade konfirmasi" id="konfirmasiModal" tabindex="-1" role="dialog" aria-labelledby="konfirmasilabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <!-- Judul Modal yang di tampilkan yaitu Konfirmasi Pembayaran -->
                            <h5 class="modal-title" id="konfirmasiModal"> Konfirmasi Pembayaran</h5>
                            <!-- button close untuk modal konfirmasi pembayaran -->
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        </div>
                        <div class="modal-body">
                            <div class="row">
                                <div class="mx-auto">
                                    <div class="card-modal">
                                        <div class="tab-content">
                                            ...
                                            <!-- Footer dari modal, disini menggunakan card karna layar modalnya hanya satu -->
